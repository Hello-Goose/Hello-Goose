...
const Faqs = forwardRef<HTMLDivElement>((props, ref) => {
  return (
    <div
      ref={ref}
      {...props}
      className="relative w-full h-full min-h-[100vh] lg:min-h-[110vh] lg:max-h-[110vh] pt-6 pb-[5rem] lg:pb-[20rem] bg-center bg-no-repeat bg-cover bg-background-faqs mobileL:bg-top TabletV:bg-center lg:pt-[5rem]"
    >
