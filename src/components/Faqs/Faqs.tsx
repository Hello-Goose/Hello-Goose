...
const Faqs = forwardRef<HTMLDivElement>((props, ref) => {
  return (
    <div
      ref={ref}
      {...props}
      className="relative w-full h-full min-h-screen lg:min-h-[110vh] pt-6 pb-10 bg-center bg-no-repeat bg-cover bg-background-faqs mobileL:bg-top TabletV:bg-center lg:pt-[8rem]"
    >
